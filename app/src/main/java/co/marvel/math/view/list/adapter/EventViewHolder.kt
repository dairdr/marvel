...
class EventViewHolder(itemView: View, private val listener: ResultOptionListener) :
        RecyclerView.ViewHolder(itemView), ResultViewHolder {
    private var resultOption: EventOption? = null
    ...
    init {
        ...
        rootView?.setOnClickListener {
            resultOption?.let { option ->
                listener.onClickEvent(option.id)
            }
        }
    ...
    override fun bindViews(option: ResultOption) {
        this.resultOption = option as EventOption
