...
class CreatorViewHolder(itemView: View, private val listener: ResultOptionListener) :
        RecyclerView.ViewHolder(itemView), ResultViewHolder {
    private var resultOption: CreatorOption? = null
    ...
    init {
        ...
        rootView?.setOnClickListener {
            resultOption?.let { option ->
                listener.onClickCreator(option.id)
            }
        }
    ...
    override fun bindViews(option: ResultOption) {
        this.resultOption = option as CreatorOption
