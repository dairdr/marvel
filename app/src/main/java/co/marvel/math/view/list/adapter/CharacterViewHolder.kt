...
class CharacterViewHolder(itemView: View, private val listener: ResultOptionListener) :
        RecyclerView.ViewHolder(itemView), ResultViewHolder {
    private var resultOption: CharacterOption? = null
    ...
    init {
        ...
        rootView?.setOnClickListener {
            resultOption?.let { option ->
                listener.onClickCharacter(option.id)
            }
        }
    ...
    override fun bindViews(option: ResultOption) {
        this.resultOption = option as CharacterOption
