...
class SerieViewHolder(itemView: View, private val listener: ResultOptionListener) :
        RecyclerView.ViewHolder(itemView), ResultViewHolder {
    private var resultOption: SerieOption? = null
    ...
    init {
        ...
        rootView?.setOnClickListener {
            resultOption?.let { option ->
                listener.onClickSerie(option.id)
            }
        }
    ...
    override fun bindViews(option: ResultOption) {
        this.resultOption = option as SerieOption
